...
def get_args():
    ...
    parser.add_argument('--output_dir', default='/mnt/c/Users/macke/Desktop/BachelorArbeit/vtv-output/nyu-segmentation')
    parser.add_argument('--device', default='cuda',
                        help='device to use for training / testing')
    parser.add_argument('--base_dir', default='/mnt/c/Users/macke/Desktop/BachelorArbeit/Datasets_VAT/', help='Datasets base dir')
    parser.add_argument('--seed', default=15, type=int)
    parser.add_argument('--t', default=[0, 0, 0], type=float, nargs='+')
    parser.add_argument('--ckpt', default="/mnt/c/Users/macke/Desktop/BachelorArbeit/vtv-ckpt/checkpoint-3400.pth", help='model checkpoint')

...
def get_args():
    ...
    parser.add_argument('--output_dir', default='/content/vtv-output/nyu-depth')
    parser.add_argument('--device', default='cuda',
                        help='device to use for training / testing')
    parser.add_argument('--base_dir', default='/content/Datasets_VAT', help='pascal base dir')
...
# def depth_loss(ours, target, mask=None):
#     if mask is not None:
#         ours = ours[mask]
#         target = target[mask]
#     return F.l1_loss(ours, target)
